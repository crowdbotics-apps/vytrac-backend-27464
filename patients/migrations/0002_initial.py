...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, related_name='Profile_emergency_contact', to='patients.EmergencyContact'),
        ),
        migrations.AddField(
            model_name='patient',
            name='ethnicity',
        ...
        migrations.AddField(
            model_name='patient',
            name='symptoms',
            field=models.ManyToManyField(blank=True, related_name='symptoms', to='patients.Symptom'),
        ),
        migrations.AddField(
            model_name='patient',
            name='user',
